...
/**
 * Servlet implementation class ARemporteLaVenteServlet
 */
@WebServlet("/ARemporteLaVenteServlet")
public class ARemporteLaVenteServlet extends HttpServlet {
	 ...
	 */
	public ARemporteLaVenteServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			modelA.setArticleVendu(manager.selectById(1));
